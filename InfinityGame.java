...
public class InfinityGame {
    ...
    private void casillaFinal(ArrayList<Jugador> jugadores, int indice, int largoTablero, int turno) {
        int posicion;
    ...
    public void casillaPortal(ArrayList<Jugador> jugadores, ArrayList<Character> casillas, int largoTablero, int indice, int posicion) {
        ...
        System.out.println("Se ha transportado a la casilla n°" + (jugadores.get(indice).getPosicion()+1));
    ...
    private void elegirJugada(ArrayList<Jugador> jugadores, int indice, int largoTablero, int cantidadJugadores, Reliquia reliquia, Guardian guardian, int turno) {
    ...
    private void casillaOpcion(ArrayList<Character> casillas, ArrayList<Jugador> jugadores, int indice, int largoTablero, int cantidadJugadores, int posicion, Reliquia reliquia, int turno) {
        ...
        switch (casillas.get(posicion)) {
            ...
            case 's':
                ...
                reliquia.reliquiaSalud(jugadores, indice);
                break;
            case 'd':
            ...
            case 'I':
                break;
            case 'F':
                casillaFinal(jugadores, indice, largoTablero, turno);
                System.exit(0);
                break;
    ...
    private void generarJuego() {
        ...
        Guardian guardian = new Guardian(jugadores);
        t.leerLargoTablero();
        t.generarTablero();
        ...
        do {
            ...
            for (int indice = 0; indice < jugadoresActivos; indice++) {
                ...
                elegirJugada(jugadores, indice, largoTablero, cantidadJugadores, reliquia, guardian, turno);
                posicion = jugadores.get(indice).getPosicion();
                casillaOpcion(casillas, jugadores, indice, largoTablero, jugadoresActivos, posicion, reliquia, turno);

            }
            Podio podio = new Podio(jugadores);
            turno++;
        } while (true);
    }
