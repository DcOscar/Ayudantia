...
public class InfinityGame {
    ...
    private void elegirJugada(ArrayList<Jugador> jugadores, int indice, int largoTablero, int cantidadJugadores, Reliquia reliquia) {
    ...
    private void casillaOpcion(ArrayList<Character> casillas, ArrayList<Jugador> jugadores, int indice, int largoTablero, int cantidadJugadores, int posicion, Reliquia reliquia) {
    ...
    private void generarJuego() {
        ...
        do {
            ...
            for (int indice = 0; indice < jugadoresActivos; indice++) {
                ...
                elegirJugada(jugadores, indice, largoTablero, cantidadJugadores, reliquia);
                posicion = jugadores.get(indice).getPosicion();
                casillaOpcion(casillas, jugadores, indice, largoTablero, jugadoresActivos, posicion, reliquia);
